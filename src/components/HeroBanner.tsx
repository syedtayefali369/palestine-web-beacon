    ...
    <section className="relative bg-gradient-to-r from-palestine-black via-palestine-black to-palestine-green pt-20 pb-12">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <div className="max-w-xl space-y-4">
              ...
              <div className="pt-4 flex flex-wrap gap-4">
                <a href="#help" className="px-6 py-3 bg-palestine-red text-white font-medium rounded-md hover:bg-red-700 transition duration-300 inline-flex items-center">
                  How to Help
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="#updates" className="px-6 py-3 bg-transparent border border-white text-white font-medium rounded-md hover:bg-white/10 transition duration-300">
                  Latest Updates
                </a>
              </div>
            </div>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative bg-gradient-to-br from-palestine-black to-gray-900 p-1 rounded-lg shadow-xl">
      ...
      <div className="container mx-auto px-4 mt-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          <div className="bg-black/30 p-4 md:p-6 rounded-lg text-center">
            <p className="text-3xl md:text-4xl font-bold text-white">37K+</p>
            <p className="text-white/80 mt-1">Lives Lost</p>
          </div>
          <div className="bg-black/30 p-4 md:p-6 rounded-lg text-center">
            <p className="text-3xl md:text-4xl font-bold text-white">1.9M</p>
            <p className="text-white/80 mt-1">Displaced</p>
          </div>
          <div className="bg-black/30 p-4 md:p-6 rounded-lg text-center">
            <p className="text-3xl md:text-4xl font-bold text-white">$15B</p>
            <p className="text-white/80 mt-1">Damage</p>
          </div>
          <div className="bg-black/30 p-4 md:p-6 rounded-lg text-center">
            <p className="text-3xl md:text-4xl font-bold text-white">500K</p>
            <p className="text-white/80 mt-1">Facing Famine</p>
          </div>
        </div>
      </div>
    </section>
